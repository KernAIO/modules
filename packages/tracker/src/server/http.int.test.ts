...
describe('service health', () => {
  it('reports the tracker among its modules', async () => {
    ...
    // health reports id *and* version: the release feed is generated by asking an image this
    expect(health.body.modules).toContainEqual({ id: 'tracker', version: expect.any(String) })
